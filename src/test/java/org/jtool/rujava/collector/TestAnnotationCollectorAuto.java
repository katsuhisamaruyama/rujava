...
public class TestAnnotationCollectorAuto {
    ...
    public void test101() {
        ...
        try {
            ...
            assertEquals("1 -> 1 defonly args$0 [IMMUTABLE/BORROW];"
    ...
    public void test106() {
        ...
        try {
            ...
            assertEquals("1 -> 6 defuse list$0 [MUTABLE/BORROW];"
                       + "3 -> 10 defuse reversedList$2 [IMMUTABLE/BORROW];"
    ...
    public void test134() {
        ...
        try {
            ...
            String dataflowInfo1 = TestUtil.getDataFlowsLongString(methods.get(1));
            assertEquals("1 -> 11 defuse imuList$0 [IMMUTABLE/BORROW];"
                       + "6 -> 3 defuse this.!of( java.lang.Object java.lang.Object ) [MUTABLE/OWNED];"
            ...
            String dataflowInfo3 = TestUtil.getDataFlowsLongString(methods.get(3));
            assertEquals("1 -> 2 defuse list$0 [IMMUTABLE/BORROW];"
