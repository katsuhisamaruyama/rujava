...
public class TestAnnotationCollectorRust {
    ...
    public void test101() {
        ...
        try {
            ...
            assertEquals("1 -> 10 defuse list$0 [IMMUTABLE/OWNED];"
                       + "1 -> 13 defuse list$0 [IMMUTABLE/OWNED];"
                       + "1 -> 15 defdefCall list$0 [IMMUTABLE/OWNED];"
                       + "1 -> 18 defuse list$0 [IMMUTABLE/OWNED];"
            ...
            assertEquals("1 -> 1 defonly args$0 [IMMUTABLE/OWNED];"
                       + "2 -> 7 defuse example$1 [IMMUTABLE/OWNED];"
                       + "2 -> 9 defdefCall example$1 [IMMUTABLE/OWNED];"
    ...
    public void test106() {
        ...
        try {
            ...
            String dataflowInfo3 = TestUtil.getDataFlowsLongString(methods.get(3));
            assertEquals("1 -> 6 defuse list$0 [MUTABLE/OWNED];"
                       + "3 -> 10 defuse reversedList$2 [IMMUTABLE/OWNED];"
    ...
    public void test134() {
        ...
        try {
            ...
            String dataflowInfo1 = TestUtil.getDataFlowsLongString(methods.get(1));
            assertEquals("1 -> 11 defuse imuList$0 [IMMUTABLE/OWNED];"
                       + "6 -> 3 defuse this.!of( java.lang.Object java.lang.Object ) [MUTABLE/OWNED];"
                       ...
                       + "13 -> 20 defdef muList$1 [IMMUTABLE/OWNED];"
                       ...
                       + "20 -> 30 defuse muList$1 [IMMUTABLE/OWNED];"
            ...
            String dataflowInfo3 = TestUtil.getDataFlowsLongString(methods.get(3));
            assertEquals("1 -> 2 defuse list$0 [IMMUTABLE/OWNED];"
                       + "2 -> 2 defdef item$1 [IMMUTABLE/OWNED];"
                       + "2 -> 5 defuse item$1 [IMMUTABLE/OWNED]",
                   dataflowInfo3);
        } catch (IOException e) {
            System.err.print(e.getMessage());
        }
