...
public class TestMutableReferenceChecker {
    ...
    public void test128() {
        ...
        try {
            ...
            MutableReferenceChecker checker = new MutableReferenceChecker();
    ...
    public void test129() {
        ...
        try {
            ...
            assertEquals("AssignMutableBorrowed:16, 31", TestUtil.getMessage(messages.get(2)));
            assertEquals("AssignMutableBorrowed:16, 35", TestUtil.getMessage(messages.get(3)));
        } catch (IOException e) {
            System.err.print(e.getMessage());
        }
    }
